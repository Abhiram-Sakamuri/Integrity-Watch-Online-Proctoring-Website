...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\tejes\PycharmProjects\Integritywatch\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\tejes\PycharmProjects\Integritywatch\venv\Scripts\deactivate.nu'
